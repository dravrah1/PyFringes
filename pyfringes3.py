...
import matplotlib
import pyfringesGUI as fringeGUI


#qtCreatorFile = "pyfringesGUI.ui" # Enter file here.
qtCreatorFile2 = "farfield.ui"
img = QtGui.QImage()
...
Ui_MainWindow = fringeGUI.Ui_MainWindow
Ui_FFWin, QtBaseClass2 = uic.loadUiType(qtCreatorFile2)
...
#        self.frame_5.setHidden(True)
        self.crossplot = MyMplCanvas(self.frame_4, width=5, height=4, dpi=100)
        self.gridLayout_5.addWidget(self.crossplot)
        self.testButton.clicked.connect(self.testbut)
    

    def testbut(self):
        aa = 10
        DialogWin = QtWidgets.QMainWindow()
        ui = Ui_FFWin()
        ui.setupUi(DialogWin)
        DialogWin.show()
...
#        sc = MyStaticMplCanvas(self.frame_4, width=5, height=4, dpi=100)
#        self.gridLayout_5.addWidget(sc)
#        self.frame_4.show()
#        sc.show()
...
#        QtWidgets.QMessageBox.information(self,"Information!","Window has been resized...")
    ...
    def GeneratePhase(self):
        ...
        xaxis = np.arange(0,N)
        self.crossplot.axes.cla()
        self.crossplot.axes2.cla()
        self.crossplot.axes.plot(xaxis,xcross)
        self.crossplot.axes2.plot(xaxis,ycross)
        self.crossplot.draw()
#        self.frame_4.show()
#        self.crossplot.show()
